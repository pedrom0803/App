...
import { ShoppingBag, UserPlus, Package, Info, ArrowRight } from "lucide-react";
    ...
    <div className="flex h-screen bg-[#F5E6D3]">
      ...
      <aside className="w-64 bg-[#D2B48C] p-6 shadow-lg">
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">ComprasExpress</h2>
        </div>
        <nav className="space-y-4">
          <button className="w-full flex items-center justify-start p-3 text-white hover:bg-[#C19A6B] rounded-lg transition-colors duration-200">
      ...
      <main className="flex-1 p-8 overflow-auto bg-white rounded-l-3xl shadow-xl">
        ...
        <div className="mb-8 bg-[#FFF8DC] border border-[#D2B48C] rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex justify-between items-center">
              {[
                ...
                { icon: Package, text: "Esperar o pedido" },
                { icon: ArrowRight, text: "Receber o pedido" },
              ].map((step, index) => (
